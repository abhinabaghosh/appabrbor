  ...
  if(properties.isAlias !== true) {
    if(properties.type === 'object') {
      if (properties.default) {
        writeValue.call(self._this, _.isFunction(properties.default) ? properties.default.call(this) : properties.default, properties);
      } else {
        writeValue.call(self._this, properties.objectType ? new properties.objectType : {}, properties);
      }
    ...
    // Additionally, other properties such as unique rely on passing through SchemaObject.
      ...
      writeValue.call(self._this, new SchemaArray(self, properties), properties);
    }
  };
};
